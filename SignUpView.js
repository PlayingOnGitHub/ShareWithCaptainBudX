...
const RegisterForm = () => {
  ...
  return (
    <div className="betterFormContainer">

      
  <div className='betterFormView' >
    <div className='innerSU' style={{borderWidth:'3px',borderColor:'green'}} >
    <div style={{textAlign:'center'}}>
     <label id='better-head-tag'> You are one step closer! </label>
    </div>
...
export const SignUpView = () => (
  <div className="yourContentContainer">
    <div className="fixed-background-image-container">
      <img className="fixed-background-image" src={backgroundIm} />
    </div>
    <div className='betterSignupContainer'>
      <RegisterForm />
